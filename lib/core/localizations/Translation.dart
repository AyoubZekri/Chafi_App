...
class MyTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    "ar": {
      ...
      "second_discount_desc_low_income": "التخفيظ الثاني حسب الصيغة القانونية",
      ...
      "please_enter_budget_value":
          "يرجى إدخال النتيجة الجبائية، مع تحديد تواريخ الإيداع والدفع.",
      "budget": "الميزانية",
      "budget_value": "النتيجة الجبائية",
      "payment_and_deposit_dates": "تواريخ الدفع والإيداع",
      "budget_date": "سنة الميزانية",
      ...
      "تأخير في دفع الضريبة": "تأخير في دفع الضريبة",
      ...
      "26_days": "26 يوم",
      "30_days": "30 يوم",
      "input_absent_days": "عدد أيام الغياب",
      ...
      "عقوبات الإيداع والدفع": "عقوبات الإيداع والدفع",
      "خدمات": "خدمات",
      "تنبيه هام": "تنبيه هام",
      "معفى من التسبيق الأول والثاني بالنسبة لسنة الأولى":
      ...
      "أنت معفى من جميع التسبيقات (الأول، الثاني، والثالث) حسب تاريخ الإنشاء":
          "أنت معفى من جميع التسبيقات (الأول، الثاني، والثالث) حسب تاريخ الإنشاء",
      "أنت معفى من التسبيق الأول والثاني حسب تاريخ الإنشاء":
          "أنت معفى من التسبيق الأول والثاني حسب تاريخ الإنشاء",
      "أنت معفى من التسبيق الأول حسب تاريخ الإنشاء":
          "أنت معفى من التسبيق الأول حسب تاريخ الإنشاء",
      "يرجى إدخال النتيجة الجبائية لتحديد ضريبة التأخير للكشف التلخيص السنوي":
          "يرجى إدخال النتيجة الجبائية لتحديد ضريبة التأخير للكشف التلخيص السنوي",
      "سكنــــــي فــــــردي أو جمــــــاعي":
          "سكنــــــي فــــــردي أو جمــــــاعي",
    ...
    "en": {
      ...
      "zone_bonus_taxable": "Taxable amount",
      "zone_bonus_exempt": "Tax-exempt amount",
      ...
      "please_enter_budget_value":
          "Please enter the tax result, specifying the deposit and payment dates.",
      "budget": "Budget",
      "budget_value": "Tax result",
      "payment_and_deposit_dates": "Payment and deposit dates",
      "budget_date": "Budget year",
      ...
      "حساب": "the account",
      "إختر نوع الإيجار": "Choose the rent type",
      ...
      "لا": "no",
      "الضريبة النهائية (15%)": "Final Tax (15%)",
      "ضريبة الفائض المستحقة": "Due surplus tax",
      "الضريبة المستحقة قبل غرامات التأخير": "Tax due before delay penalties",
      "غرامة التأخير في الإيداع": "Deposit delay penalty",
      "تأخير في إيداع التصريح": "Delay in filing the declaration",
      "غرامة التأخير في الدفع": "Payment delay penalty",
      "تأخير في دفع الضريبة": "Delay in tax payment",
      ...
      "26_days": "26 days",
      "30_days": "30 days",
      "input_absent_days": "the number of days of absence",
      ...
      "غرامة تأخير الدفع": "Late payment penalty",
      "غرامة تأخير الإيداع": "Late deposit penalty",
      "جانفي": "January",
      "فيفري": "February",
      "مارس": "March",
      "أفريل": "April",
      ...
      "نوفمبر": "November",
      "ديسمبر": "December",
      "الثلاثي الأول": "First Quarter",
      "الثلاثي الثاني": "Second Quarter",
      "الثلاثي الثالث": "Third Quarter",
      ...
      "عقوبات الإيداع والدفع": "Deposit and payment penalties",
      "خدمات": "Services",
      ...
      "أنت معفى من التسبيق الأول والثاني حسب تاريخ الإنشاء":
          "You are exempt from the first and second advances based on the creation date",
      "أنت معفى من التسبيق الأول حسب تاريخ الإنشاء":
          "You are exempt from the first advance based on the creation date",
      "يرجى إدخال النتيجة الجبائية لتحديد ضريبة التأخير للكشف التلخيص السنوي":
          "Please enter the tax result to determine the delay tax for the annual summary disclosure",
      "سكنــــــي فــــــردي أو جمــــــاعي":
          "Individual or collective residential",
      "للإستعمــــــــــــال الفلاحـــــــــــي": "For agricultural use",
      "تجاري أو مهني غير مزود بي أثاث":
