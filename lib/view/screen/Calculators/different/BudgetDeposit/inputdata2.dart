...
class Inputdata2 extends StatefulWidget {
  const Inputdata2({super.key});

  @override
  State<Inputdata2> createState() => _Inputdata2State();
}

class _Inputdata2State extends State<Inputdata2> {
