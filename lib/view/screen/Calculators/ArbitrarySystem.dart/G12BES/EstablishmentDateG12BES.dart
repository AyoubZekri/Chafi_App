...
class EstablishmentDateG12BES extends StatelessWidget {
  const EstablishmentDateG12BES({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<G12bescontroller>();
    return WillPopScope(
      onWillPop: () async {
                    ...
                    child: Column(
                      children: [
                        ...
                        Custemsuberbutton(
                          ...
                          color: AppColor.typography,
                          onPressed: () {
                            controller.validateAndProceedFromEstablishmentDate();
                          },
                        ),
                      ],
                    ),
